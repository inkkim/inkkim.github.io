...
class StaticPublisher {
  public static publishSitemap() {
    ...
    const SITEMAP_PATH_SUB: string = path.join(__dirname, '../');
...
<url><loc>https://inkkim.github.io/</loc><lastmod>${dayjs().format('YYYY-MM-DDTHH:mm:ss')}+00:00</lastmod><changefreq>daily</changefreq><priority>1.00</priority></url>
${workUrls.join('\n')}
${articleUrls.join('\n')}
</urlset>
`;
